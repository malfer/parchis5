Welcome to Parchis v5.2

Parchís v5.2 is a computer program to play Parchís, a board game very popular
...
lots of improvements. Parchís v5 is a new rewrite in C, using the latest
...
Parchís v5.2 installation instructions
======================================

Requirements:
-------------

  The source files:  parchv52.zip
  This document:     readme.txt

Dependencies:
-------------

  Before compiling Parchís v5.2 you must have MGRX with PNG support instaled
  in your system, at least in his version 1.5.1. Go to www.fgrim.com/mgrx for
  instructions.

A. Unpacking the Parchís v5.2 archive
-------------------------------------

  1) 'cd' to a directory where you want the Parchís v5.2 file tree to be
  ...
  2) Unpack the Parchís v5.2 archive:

        unzip parchv52.zip

     This will create the subdirectory 'parchv51'.

B. Compiling Parchís v5.2
-------------------------

  1) Go to the "parchv52" directory
  ...
  2) run 'make -f <your makefile>':
     ...
     makefile.wyl for Linux/Wayland

     This process generates the "parchis5" executable ("xparchis5" for the
     X11 version, "wparchis5" for the Wayland version).
...
=======
  ...
  Parchís v5.2 is free software, you can redistribute and/or modify it under
