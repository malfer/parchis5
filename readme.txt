Welcome to Parchis v5

Parchís v5 is a computer program to play Parchís, a board game very popular
...
Parchís v5 installation instructions
====================================

Requirements:
-------------

  The source files:  parchv50.zip
...
-------------
  ...
  your system, at least in his version 1.3.3. Go to www.fgrim.com/mgrx for
  instructions.

A. Unpacking the Parchís v5 archive
-----------------------------------

  1) 'cd' to a directory where you want the Parchís v5 file tree to be created
  ...
  2) Unpack the Parchís v5 archive:

        unzip parchv50.zip

     This will create the subdirectory 'parchv50'.

B. Compiling Parchís v5
-----------------------

  1) Go to the "parchv50" directory
...
=======
  ...
  Parchís v5 is free software, you can redistribute and/or modify it under
  the GPLv3 license. See the "LICENSE" file for details.

  Files on the "pfiles" subdirectory are all my own work and I want to release
